...
const Profile = (props) => {
    ...
    const fetchData = async () => {
        try {
            const response = await axios.get("http://192.168.3.150:8055/flows/trigger/df524185-f718-4c57-891d-0761aabbd03e?sort=sort,-notes.date_updated,-notes.date_created&page=0", {
                headers: {
                    Accept: "*/*",
    ...
    const fetchDataStatic = async () => {
        ...
        const url = 'http://192.168.3.150:8055/flows/trigger/22833381-b10f-45c5-a4ee-f90aa8b34f73';
                ...
                <div className="rounded-2xl p-4 bg-white"
                    ...
                    <div className="bg-[#F6F6F6] p-4 rounded-2xl"
                        ...
                        <div className="flex items-center justify-center pb-4">
                            <div className="profile-pic px-[50px] pt-[38px]">
                                ...
                                {profileDetails && (
                                    <img
                                        src={`http://192.168.3.150:8055/assets/${profileDetails?.avatar}`}
                                        id="output"
                                        width="500"
                                        alt="Profile"
                                    />
                    ...
                    <div className="pt-11">
                        ...
                        <div className="flex items-center justify-center">
                            <img
                                src={`http://192.168.3.150:8055/assets/${rankDetails?.image}`}
                                id="output"
                                width="130"
                                alt="RankAvatar"
                            />
